window.addEventListener('DOMContentLoaded', function(){
    ...
    class Player {
        constructor(gameWidth, gameHeight){
            ...
            //console.log(gameHeight, this.height, this.y);
    ...
    function displayStatusText(context){
        ...
        if (gameOver){
            ...
            context.fillStyle = 'black';
            context.fillText('Game Over, press Enter or swipe down to restart!', canvas.width/2, 360);
            context.fillStyle = 'white';
            context.fillText('Game Over, press Enter or swipe down to restart!', canvas.width/2 + 2, 362);
        }
    }
